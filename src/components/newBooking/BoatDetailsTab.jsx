...
const BoatDetailsTab = ({
  ...
  const selectedBoatDetails = useMemo(
    () => boatData.find(boat => boat.id === selectedBoat),
    ...
    <>
      ...
      <View style={styles.boatSelectionWrapper}>
        ...
        <Dropdown
          style={[
            styles.dropdown,
            {
              ...
              borderColor: isDarkMode
                ? Colors.input_border_dark
                : Colors.input_border_light,
            },
          ]}
          placeholderStyle={[
            styles.placeholderStyle,
            { color: isDarkMode ? Colors.dark_text_secondary : '#C8C8C8' },
          ]}
          selectedTextStyle={[
            styles.selectedTextStyle,
            { color: isDarkMode ? Colors.white : '#000', fontWeight: '600' },
          ]}
          inputSearchStyle={[
            styles.inputSearchStyle,
            {
              ...
              backgroundColor: isDarkMode
                ? Colors.dropdown_container_dark
                : Colors.dropdown_container_light,
            },
          ]}
          ...
          activeColor={
            isDarkMode
              ? Colors.dropdown_selected_dark
              : Colors.dropdown_selected_light
          }
          containerStyle={{
            backgroundColor: isDarkMode
              ? Colors.dropdown_container_dark
            ...
            borderWidth: 1,
            borderColor: isDarkMode
              ? Colors.dropdown_border_dark
              : Colors.dropdown_border_light,
          }}
        />
      </View>
      ...
      <View style={styles.formInputRow}>
        ...
        {/* TODO: remove flex: 0.5 if width is added */}
        <View style={[styles.formInputContainer, { flex: 0.5 }]}>
          <View style={styles.formLabelContainer}>
            <Text
              style={[
                styles.inputLabel,
